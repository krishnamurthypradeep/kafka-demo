...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3936179924640897860L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLineItem\",\"namespace\":\"com.myapp.kafka.domain\",\"fields\":[{\"name\":\"productId\",\"type\":\"string\"},{\"name\":\"productName\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"unitPrice\",\"type\":\"double\"}]}");
   ...
   */
  public OrderLineItem(java.lang.CharSequence productId, java.lang.CharSequence productName, java.lang.Integer quantity, java.lang.Double unitPrice) {
   ...
   */
  public static com.myapp.kafka.domain.OrderLineItem.Builder newBuilder() {
    return new com.myapp.kafka.domain.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.myapp.kafka.domain.OrderLineItem.Builder newBuilder(com.myapp.kafka.domain.OrderLineItem.Builder other) {
    if (other == null) {
      return new com.myapp.kafka.domain.OrderLineItem.Builder();
    } else {
      return new com.myapp.kafka.domain.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.myapp.kafka.domain.OrderLineItem.Builder newBuilder(com.myapp.kafka.domain.OrderLineItem other) {
    if (other == null) {
      return new com.myapp.kafka.domain.OrderLineItem.Builder();
    } else {
      return new com.myapp.kafka.domain.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.myapp.kafka.domain.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.myapp.kafka.domain.OrderLineItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder setProductId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder setProductName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder clearProductName() {
      productName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder setUnitPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.myapp.kafka.domain.OrderLineItem.Builder clearUnitPrice() {
